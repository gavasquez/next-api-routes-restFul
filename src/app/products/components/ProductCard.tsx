...
import { addProductToCart, remoteProductFromCart } from '@/shopping-cart/actions/actions';
...
export const ProductCard = ( { id, name, price, rating, image }: Props ) => {
  ...
  const onRemoteFromCart = () => {
    remoteProductFromCart( id );
    router.refresh();
  }


  return (
    <div className="shadow rounded-lg max-w-sm bg-gray-800 border-gray-100 mb-2">
